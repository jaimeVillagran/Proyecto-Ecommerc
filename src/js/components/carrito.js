...
const btnCart = document.querySelector(".card__button");
...
btnCart.addEventListener("click", function () {
	...
	const name = this.parentNode.querySelector('input[name="name"]').value;
	const price = this.parentNode.querySelector('input[name="price"]').value;
